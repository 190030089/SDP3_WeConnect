          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <h3>Address</h3>
                <p>Srinagar Colony<br>Guntur, AP 522034</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <h3>Call Us</h3>
                <p>+91 93901 53350<br>+91 96187 55665</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
                <i class="bi bi-envelope"></i>
                <h3>Email Us</h3>
                <p>weconnect@gmail.com<br>contact@gmail.com</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
          ...
          <div class="card p-4">
              ...
              <div class="row gy-4">
				<form action="/sendMessage" method="post" >
					<label for="img">Post A Message</label><br><br>
					<input type="text" id="text" name="message" ><br><br>
					<input class="btn btn-primary btn-sm bi bi-upload" title="Upload new profile image" type="submit" value="Send">
				</form>
              </div>
