    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Politician Apply Status</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-60">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Politician Status</h5>
				<% 
					if(c.getPo())
					{
						out.println("Already A Politician");
					}
						...
						if(c.isApplyStatus()){
							...
							%>
							<p>You are not a Politician Apply for to get Politician Status</p>
							<form action="apply">
