            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card1 mb-3">
                ...
                <div class="card-body">
                  ...
                  <form name="myform" class="row g-3 needs-validation" novalidate action="addCitizen">

                    <div class="col-12">
                      <label for="addhar" class="form-label">Your Addhar Number</label>
                      <input type="text" name="aadhaar" class="form-control" id="addhar" required>
                      <div class="invalid-feedback">Please, enter your addhar!</div>
                    </div>
