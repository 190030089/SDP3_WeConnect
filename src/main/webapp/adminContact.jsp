      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="assets\img\pro2.jfif" alt="Profile" class="rounded-circle">
  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="row">
        ...
        <c:forEach var="mr" items="${m}" >
        <div class="col-lg-60">
          <div class="card">
            <div class="card-body">
			 <div class="card-title"><c:out value="Sent From ${mr.fromName}" /></div>
             <div class="col-sm-2 col-form-label"><c:out value="${mr.message }"/> </div>
            </div>
          </div>
        </div>
